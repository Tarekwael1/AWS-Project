...
# 8-Create an EC2 instance to run your AI models and configure them with the necessary software and dependencies, such as Python, TensorFlow, or PyTorch, depending on the specific AI models you intend to run.
...
# 9-To create a S3 bucket to store static files, go to S3 in the AWS Management Console.
...
3- Go to AWS Glue.
 ...
 ===>Choose the Glue database. If you do not have one, create a new one.
 ...
 ===>From (+) choose to transform -->Custom transform.
